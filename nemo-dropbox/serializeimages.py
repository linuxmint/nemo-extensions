...
if __name__ == '__main__':
    ...
    src2dest = {'@PACKAGE_VERSION@': sys.argv[1],
                ...
                '@IMAGEDATA64@': ("GdkPixbuf.Pixbuf.new_from_file(%r, GdkPixbuf.Colorspace.RGB, %r, %r, %r, %r, %r, None)" %
                ...
                '@IMAGEDATA16@': ("GdkPixbuf.Pixbuf.new_from_file(%r, GdkPixbuf.Colorspace.RGB, %r, %r, %r, %r, %r, None)" %
